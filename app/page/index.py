...
column1 = dbc.Col(
    [
        dcc.Markdown(
            ...
            ✅ Test Heroku is a running app that adapts to your fitness levels and designs personalized workouts to help you 
            improve your running. 

            ❌ Test Heroku is the only intelligent running app that uses sophisticated deep neural net machine learning to 
